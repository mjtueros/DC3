...
- Create a DC3FluxGenerator, that creates event geometries and energies according to some distributions.
  ...
  - It would be nice to have a script that reads an already produced database and does the plots. This is related to the "dry run" idea.
    - Maybe develop a function that gets as input the database vectors?
    - and a function that reads the database and expose those vectors?
